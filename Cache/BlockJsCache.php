...
namespace Positibe\Bundle\OrmBlockBundle\Cache;
...
CONTENT
            ...
            $dashifiedId,
            $dashifiedId,
            $this->router->generate('positibe_orm_block_js_sync_cache', $keys, true)
        );
    }
...
CONTENT
            ,
            $this->dashify($keys['block_id']),
            $this->router->generate('positibe_orm_block_js_async_cache', $keys, true)
        );
    }
